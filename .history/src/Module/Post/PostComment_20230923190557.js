...
const PostComment = () => {
  ...
  return (
    <div className="mb-14 p-">
      <Heading>Bình Luận</Heading>
      <div className="px-10 py-4 w-full relative border rounded-lg border-slate-200">
        <textarea
          className="w-2/3 max-h-[150px] h-[150px]  overflow-y-auto resize-none px-10 py-7 z-50"
          placeholder="Ý kiến của bạn"
          onChange={handleOnChange}
          maxLength={150}
        ></textarea>
        <div className="w-2/3 px-12 flex items-center justify-between absolute bottom-3 left-3">
