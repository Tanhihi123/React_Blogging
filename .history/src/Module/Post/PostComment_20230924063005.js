  ...
  return (
    <div className="comment mb-14">
      ...
      {userInfo ? (
        <div className="px-5 py-3 w-3/4 relative border rounded-lg border-slate-200 shadow-[rgba(13,_38,_76,_0.19)_0px_9px_20px]">
          ...
          <div className="w-full px-5 flex items-center justify-between absolute bottom-3 left-3">
            ...
            <div className="flex justify-center gap-x-6 relative">
              <div className="picker absolute right-0 bottom-14 translate-x-3/4">
              ...
              <div className="flex gap-x-10">
                ...
                <button className="py-2 px-5 rounded-xl bg-green-300 text-center" onClick={handleComment}>
                  <span>Gửi</span>
                </button>
              </div>
            </div>
        ...
        <div className="w-3/4 h-[150px] bg-red-200 rounded-xl flex items-center justify-center">
          <span className="text-lg font-medium">
            <Link to={"/sign-up"}>
              <span className="text-red-600 cursor-pointer">Đăng ký </span>
            </Link>
            hoặc
            <Link to={"/sign-in"}>
              <span className="text-red-600 cursor-pointer"> đăng nhập</span>{" "}
            </Link>
            để bình luận
          </span>
        </div>
