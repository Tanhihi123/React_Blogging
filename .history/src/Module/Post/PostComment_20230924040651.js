    ...
    <div className="comment mb-14">
      ...
      {userInfo ? (
        ...
        <div className="w-3/4 h-[150px] bg-red-200 rounded-xl flex items-center justify-center">
          <span className="text-lg font-medium"><span className="text-red-600 cursor-pointer">Đăng ký</span> hoặc <span className="text-red-600">đăng nhập</span> để bình luận</span>
        </div>
      )}
    </div>
  );
