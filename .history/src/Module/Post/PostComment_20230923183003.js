...
const PostComment = () => {
  ...
  //   setIconRight(
  //     window.innerWidth - refIcon.current.getBoundingClientRect().right
  //   );
  // }, [refIcon]);
  return (
    <div className="mb-14">
      ...
      <div className="p-10 w-full relative">
        ...
        <div className="flex flex-col gap-y-5">
          <div className="w-2/3 p-12 flex items-center justify-between absolute bottom-3 left-3">
            <span>0/15</span>
            <div className="flex justify-center gap-x-6 relative" ref={refIcon}>
              <div className="absolute right-0 bottom-10 translate-x-3/4">
              ...
              <button className="py-2 px-3 rounded-xl bg-green-300 text-center">Gửi</button>
            </div>
          </div>
        </div>
      </div>
