...
const PostComment = () => {
  ...
  useEffect(() => {
    let locationX = refIcon.current.getBoundingClientRect().x;
    let locationY = refIcon.current.getBoundingClientRect().y;
  },[])
  return (
    <div className="mb-14">
      ...
      <div className="p-10 w-full relative">
        ...
        ></textarea>
        {show && <Picker onEmojiClick={onEmojiClick} emojiStyle="flex"/>}
