  ...
  return (
    <div className="comment mb-14">
      ...
      {userInfo ? (
        ...
        <div className="w-3/4 h-[150px] bg-red-200 rounded-xl">
          <span className="text-lg font-medium  m-auto"><span className="text-red-600">Đăng ký</span> hoặc <span className="text-red-600">đăng nhập</span> để bình luận</span>
        </div>
      )}
    </div>
  );
